...
public class FlashActivity extends Activity implements SplashADListener {
	private Timer timer;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (NetHelper.IsHaveInternet(this)) {
			...
			new SplashAD(this, container, gdtAdsConstants.APPID,
					gdtAdsConstants.SplashPosID, this);
		} else {
			timer = new Timer();
		...
		new Thread(new Runnable() {
			public void run() {
//				if(AppInstalledUtil.isAppInstalled(getApplicationContext(), "com.bingo.lattern"))
//				{
...
//				}
	...
	private void initData() {
		...
		Riddle riddle12	= new Riddle("	妇女们在不知不觉中丢失掉的东西是什么？(猜一猜) 	","	 美貌	", "经典"	, "无");
		Riddle riddle13	= new Riddle("	航空公司开张(猜一成语) 	","	 有机可乘	", "经典"	, "无");
		Riddle riddle14	= new Riddle("	隔河相望，终到相聚时(打一七夕景观) 	","	 牵牛星、织女星相会	", "经典"	, "无");
		Riddle riddle15	= new Riddle("	大伟在电影最精彩的时候却上厕所，为什么？(猜一猜) 	","	 因为大伟没有看电影	", "经典"	, "无");
		Riddle riddle16	= new Riddle("	凸眼睛，阔嘴巴，尾巴要比身体大，碧绿水草衬着它，好像一朵大红花。(打一动物)	","	 金鱼	", "经典"	, "无");
		...
		Riddle riddle41	= new Riddle("	美美晚餐好心情，熊熊火炉暖人心(打一国外节日) 	","	 平安夜	", "经典"	, "无");
		...
		Riddle riddle45	= new Riddle("	绿豆自杀，从六楼跳了下来,流了很多血,怎么样了？ (猜一猜)	","	 变成了红豆	", "经典"	, "无");
		Riddle riddle46	= new Riddle("	张着小雨伞,常站大树下，干湿都能吃，味美营养大(打一菌类) 	","	 蘑菇	", "经典"	, "无");
		Riddle riddle47	= new Riddle("	小小绿叶水里生，水珠爱在上面玩(打一植物) 	","	 荷叶	", "经典"	, "无");
		Riddle riddle48	= new Riddle("	一件东西大无边，能装三百多个天，还装月亮十二个，它换衣服过新年。(打一物)	","	 日历	", "经典"	, "无");
		Riddle riddle49	= new Riddle("	时而成烟，时而成线，遇见了海，还能变盐(打一自然物体) 	","	 水	", "经典"	, "无");
		Riddle riddle50	= new Riddle("	此物老家在非洲，力大气壮赛过牛，血盆大口吼一声，吓得百兽都发抖。(打一动物)	","	 狮子	", "经典"	, "无");
		Riddle riddle51	= new Riddle("	心惊胆战(打一离合字) 	","	 心具惧	", "经典"	, "无");
		Riddle riddle52	= new Riddle("	整天都是太阳(打一城市) 	","	 拉萨(拉萨称为“日光城”)	", "经典"	, "无");
		...
		Riddle riddle57	= new Riddle("	掘墓鞭尸报父仇，门客挖眼挂东门(打一历史人物) 	","	 伍子胥	", "经典"	, "无");
		Riddle riddle58	= new Riddle("	输氧(打一离合字) 	","	 乞一气	", "经典"	, "无");
		Riddle riddle59	= new Riddle("	饭店里有三个女人在吃香肠：一个是咬着吃的，一个是舔着吃的，一个是裹着吃的，请问这三个女人哪个结过婚？(猜一猜) 	","	 戴戒指的那个女人结过婚	", "经典"	, "无");
		Riddle riddle60	= new Riddle("	小明和朋友去海边玩，突然海浪把小明卷走，请问小明的朋友叫什么？ (猜一猜)	","	 叫救命	", "经典"	, "无");
		Riddle riddle61	= new Riddle("	晚唐长安诞才女，未入正史传千古(打一女诗人) 	","	 鱼玄机	", "经典"	, "无");
		Riddle riddle62	= new Riddle("	海市蜃楼(打一李白诗句) 	","	 眼前有景道不得	", "经典"	, "无");
		Riddle riddle63	= new Riddle("	既能投笔又能从戎 (猜一猜)	","	 刘	", "经典"	, "无");
		Riddle riddle64	= new Riddle("	翻跟斗最在行，长有六张脸，还有二十一只眼(打一物) 	","	 骰子	", "经典"	, "无");
		Riddle riddle65	= new Riddle("	身子黑不溜秋，喜往泥里嬉游，常爱口吐气泡，能够观察气候。(打一动物)	","	 泥鳅	", "经典"	, "无");
		Riddle riddle66	= new Riddle("	脱去黄金袍，露出白玉体，身子比豆小，名字有三尺(猜一猜) 	","	 大米	", "经典"	, "无");
		...
		Riddle riddle80	= new Riddle("	梅花满天飞，芳香扑鼻来(打一诗句) 	","	 遥知不是雪，为有暗香来	", "经典"	, "无");

		Riddle riddle81	= new Riddle("	青蛙为什么能比树跳得高？(猜一猜) 	","	 因为树不会跳	", "动物"	, "无");
		Riddle riddle82	= new Riddle("	小小白姑娘,住在硬壳乡,做成盘中餐,味美扑鼻香(打一动物) 	","	 田螺	", "动物"	, "无");
		Riddle riddle83	= new Riddle("	穿着盔甲爱钻洞，全身是宝大家爱(打一动物) 	","	 穿山甲	", "动物"	, "无");
		Riddle riddle84	= new Riddle("	美丽无比似女神，求爱时来把屏开(打一动物) 	","	 孔雀	", "动物"	, "无");
		Riddle riddle85	= new Riddle("	朝为越溪女，暮作吴宫妃探骊格 (猜一猜) 	","	 泊人·时迁	", "动物"	, "无");
		Riddle riddle86	= new Riddle("	贼头贼脑爱偷油,花猫一叫赶紧溜(打一动物) 	","	 老鼠	", "动物"	, "无");
		Riddle riddle87	= new Riddle("	五毒之首千足虫，若咬一口鲜血涌(打一动物) 	","	 蜈蚣	", "动物"	, "无");
		Riddle riddle88	= new Riddle("	远看像只猫，捕猎身手好。游泳又爬树，不吃青青草(打一动物) 	","	 豹	", "动物"	, "无");
		Riddle riddle89	= new Riddle("	生肖中，最骇人的是哪3个？(猜一猜) 	","	 猪、龙、鸡(朱熔基)	", "动物"	, "无");
		Riddle riddle90	= new Riddle("	有头没有颈，身上冷冰冰，有翅不能飞，无脚也能行(打一动物)。 	","	 鱼	", "动物"	, "无");
		Riddle riddle91	= new Riddle("	懂得 (打一动物) 	","	 知了(蝉)	", "动物"	, "无");
		Riddle riddle92	= new Riddle("	小英雄，爱捉虫，冬天一来躲进洞(打一动物) 	","	 青蛙	", "动物"	, "无");
		Riddle riddle93	= new Riddle("	身穿白袍戴红帽，脖长走路摇啊摇。扁嘴有翅水陆行，红掌爱把清波扰。(打一动物)	","	 鹅	", "动物"	, "无");
		Riddle riddle94	= new Riddle("	左右不分，正反不知(打一动物) 	","	 鱼	", "动物"	, "无");
		Riddle riddle95	= new Riddle("	羽毛鲜艳呈七色，却爱花粉小八哥(打一动物) 	","	 虹彩吸蜜鹦鹉	", "动物"	, "无");
		...
		Riddle riddle102	= new Riddle("	一位小姑娘,身穿花衣裳，百花是朋友，春天聚会忙(打一昆虫) 	","	 蝴蝶	", "动物"	, "无");
		Riddle riddle103	= new Riddle("	身边嗅一嗅,专把毒品搜,警察夸奖它,是个好帮手(打一动物) 	","	 缉毒犬	", "动物"	, "无");
		Riddle riddle104	= new Riddle("	左边有一只公羊右边有一只母羊中间有一只小羊为什么狼吃了小羊	","	 公羊和母羊都是雕塑	", "动物"	, "无");
		Riddle riddle105	= new Riddle("	一个长鼻子，长长猴尾巴，变色龙眼睛，夜夜水中游(打一动物) 	","	 海马	", "动物"	, "无");
		Riddle riddle106	= new Riddle("	春天睡觉，夏天出来，趴在树上，整天吵闹(打一昆虫动物) 	","	 蝉(知了)	", "动物"	, "无");
		Riddle riddle107	= new Riddle("	小小鱼儿五个角(打一动物) 	","	 海星	", "动物"	, "无");
		Riddle riddle108	= new Riddle("	身笨力气大，干活常带枷，春耕和秋种，不能缺少它。(打一动物) 	","	 牛	", "动物"	, "无");
		Riddle riddle109	= new Riddle("	迎风飞千里,能把信息送,城市和门牌,它都记得清(打一动物) 	","	 信鸽	", "动物"	, "无");
		Riddle riddle110	= new Riddle("	爱游泳，季节变，皮毛跟着变(打一动物) 	","	 水獭	", "动物"	, "无");
		Riddle riddle111	= new Riddle("	一位姑娘真漂亮,橘红衣裳披上身.嵌上七颗黑星星，蚜虫见了无影踪。(打一动物)	","	 瓢虫	", "动物"	, "无");
		Riddle riddle112	= new Riddle("	鹿的角，牛的蹄，天生喜水又喜泥。骆驼脖子驴的尾，回到故乡来定居。( 打一动物)	","	 麋鹿	", "动物"	, "无");
		Riddle riddle113	= new Riddle("	黑身红嘴卷羽毛，长脖像2很高贵(打一鸟类) 	","	 黑天鹅	", "动物"	, "无");
		Riddle riddle114	= new Riddle("	关公的命很不好，这是为什么啊？ (猜一猜)	","	 红颜薄命(红脸关公)	", "动物"	, "无");
		Riddle riddle115	= new Riddle("	引力检测(打一动物) 	","	 考拉	", "动物"	, "无");
		Riddle riddle116	= new Riddle("	一生都在忙,飞在百花乡,围着花儿转，花汁变蜜糖(打一昆虫) 	","	 蜜蜂	", "动物"	, "无");
		Riddle riddle117	= new Riddle("	长着尖尖牙，森林称霸王(打一动物) 	","	 老虎	", "动物"	, "无");
		Riddle riddle118	= new Riddle("	什么东西装玻璃，爱把鼻子当马骑？ (猜一猜)	","	 眼镜	", "动物"	, "无");
		Riddle riddle119	= new Riddle("	长长脖子同树高，身披白纹褐斑点，又长又细四条腿(打一动物) 	","	 长颈鹿	", "动物"	, "无");
		Riddle riddle120	= new Riddle("	小小飞蛾好夜游，闪闪屁股诱异性(打一动物) 	","	 萤火虫	", "动物"	, "无");
		Riddle riddle121	= new Riddle("	绿色刀郎三角头，大眼明亮雌性强(打一动物) 	","	 螳螂	", "动物"	, "无");
		Riddle riddle122	= new Riddle("	养的最多的鸡是什么鸡 (猜一猜)	","	 手机(手鸡 人手一部)	", "动物"	, "无");
		Riddle riddle123	= new Riddle("	大大红掌水中摆，长长脖子一排排(打一动物) 	","	 鹅	", "动物"	, "无");
		Riddle riddle124	= new Riddle("	浑身雪翼腿儿黑，最喜成群上青天(打一动物) 	","	 白鹭	", "动物"	, "无");
		Riddle riddle125	= new Riddle("	题目：昨夜蟋蟀鸣不停，惊回梦里已三更。起来独自绕街行，悄悄窗外月胧明。(猜一猜)	","	 老鼠	", "动物"	, "无");
		Riddle riddle126	= new Riddle("	头顶大黑帽，身着燕尾服。(打一动物) 	","	 企鹅	", "动物"	, "无");
		Riddle riddle127	= new Riddle("	败得真窝囊(打一动物) 	","	 北极熊	", "动物"	, "无");
		Riddle riddle128	= new Riddle("	下面出场的这位嘉宾可是我们中国男人的骄傲,是个歌星,你猜是谁 	","	 古巨鸡	", "动物"	, "无");
		Riddle riddle129	= new Riddle("	谁最喜欢咬文嚼字？ (猜一猜)	","	 蛀书虫	", "动物"	, "无");
		Riddle riddle130	= new Riddle("	什么东西越削越粗 (猜一猜)	","	 井、土削的越多，洞就越大(粗)	", "动物"	, "无");
		Riddle riddle131	= new Riddle("	色彩鲜艳丛中飞，鳞片雨衣格外美(打一动物) 	","	 蝴蝶	", "动物"	, "无");
		Riddle riddle132	= new Riddle("	全身雪白尾翼黑，红冠细腿白富美(打一动物) 	","	 丹顶鹤	", "动物"	, "无");
		Riddle riddle133	= new Riddle("	妈妈长得怪，肚前挂口袋，蹦蹦跳跳真可爱(打一动物) 	","	 袋鼠	", "动物"	, "无");
		Riddle riddle134	= new Riddle("	小小家伙眼睛亮，花中采宝回家酿(打一动物) 	","	 蜜蜂	", "动物"	, "无");
		Riddle riddle135	= new Riddle("	珍贵的动物打一生肖 (猜一猜)	","	 龙	", "动物"	, "无");
		Riddle riddle136	= new Riddle("	弯弯嘴儿亮眼睛，捕捉野兔它最行；千里眼儿看得清，一口吞下便清零(打一动物)	","	 鹰	", "动物"	, "无");
		Riddle riddle137	= new Riddle("	驼背老公公，胡子毛烘烘，热火锅里去洗澡，青袍换成大给红袍。 (猜一猜)	","	 虾	", "动物"	, "无");
		Riddle riddle138	= new Riddle("	古时明月虫影飞，世代草木永相随(打一动物)	","	 蝴蝶(虫+古+月=蝴，虫+世+木=蝶)	", "动物"	, "无");
		Riddle riddle139	= new Riddle("	脖子长，爱吃鱼，天天吃鱼吐出来(打一动物) 	","	 鸬鹚	", "动物"	, "无");
		Riddle riddle140	= new Riddle("	虽然不说话,本领呱呱叫,鼻子特别灵,破案功劳大(打一动物) 	","	 警犬	", "动物"	, "无");
		Riddle riddle141	= new Riddle("	软软绒毛白又白,两只耳朵竖起来。红红眼睛三瓣嘴，爱吃萝卜爱吃菜(打一动物)	","	 小白兔	", "动物"	, "无");
		Riddle riddle142	= new Riddle("	前有毒夹，后有尾巴， 全身二十一节，中药铺要它。(打一动物) 	","	 蜈蚣	", "动物"	, "无");
		Riddle riddle143	= new Riddle("	小小个头三尺高，头顶羽冠模样俏，爱把锦袍来炫耀(打一动物) 	","	 孔雀	", "动物"	, "无");
		...
		Riddle riddle147	= new Riddle("	一个白发老妈妈，走起路来四边爬，不用铁鎝不用锄，种下一片好芝麻(打一动物)	","	 蚕蛾	", "动物"	, "无");
		...
		Riddle riddle152	= new Riddle("	过去拉犁干活快,如今栏里挤牛奶。过去拉粮几千斤,如今肉嫩餐桌摆(打一动物)	","	 牛	", "动物"	, "无");
		Riddle riddle153	= new Riddle("	浑身肌肉最爱跳，胸前大兜装宝宝(打一动物) 	","	 袋鼠	", "动物"	, "无");
		Riddle riddle154	= new Riddle("	小小蘑菇海里游，会发光来不怕黑(打一动物) 	","	 水母	", "动物"	, "无");
		Riddle riddle155	= new Riddle("	羊，猪，熊，狗，猴哪一个动物用眉毛呼吸 	","	 羊(扬(羊)眉吐气)	", "动物"	, "无");
		Riddle riddle156	= new Riddle("	双亲不同种，杂交不生育(打一动物) 	","	 骡子	", "动物"	, "无");
		Riddle riddle157	= new Riddle("	刚出生的婴儿(打一动物) 	","	 猫头鹰(毛头婴)	", "动物"	, "无");
		Riddle riddle158	= new Riddle("	小小一头牛,不拉犁和耧。力气虽不大，背着房子走(打一动物) 	","	 蜗牛	", "动物"	, "无");
		Riddle riddle159	= new Riddle("	小小脑袋三根毛，五彩羽毛似扇子(打一动物) 	","	 孔雀	", "动物"	, "无");
		Riddle riddle160	= new Riddle("	形似小飞机,飞东又飞西。夏天吃蚊虫，还能报天气。(打一动物) 	","	 蜻蜓	", "动物"	, "无");

		Riddle riddle161	= new Riddle("	八姑娘(打一称谓) 	","	 空中小姐	", "爱情"	, "无");
		Riddle riddle162	= new Riddle("	姑娘月下摆瓜果，祈求收获好姻缘。(打一节日) 	","	 七夕节	", "爱情"	, "无");
		Riddle riddle163	= new Riddle("	有一个人到国外去，为什么他周围的都是中国人？(猜一猜) 	","	 外国人到了中国	", "爱情"	, "无");
		Riddle riddle164	= new Riddle("	在厕所遇见朋友时，最好不要问哪一句话？(猜一猜) 	","	 你吃了吗	", "爱情"	, "无");
		Riddle riddle165	= new Riddle("	人为什么要走去床上睡觉呢 (猜一猜)	","	 因为床不会自己走过来	", "爱情"	, "无");
		...
		Riddle riddle172	= new Riddle("	寒山寺上一棵竹，不能做称有人用，此言非虚能兑现，只要有情雨下显，天鹅一出鸟不见。 (猜一猜)	","	 等你说爱我	", "爱情"	, "无");
		Riddle riddle173	= new Riddle("	日长夜短愁几许，高处无口几人来，一人游弋芳草地，十士脚长披蓑衣，天鹅展翅鸟已飞，白勺烹酒无意义，空余一钩三点雨! (猜一猜)	","	 月亮代表我的心	", "爱情"	, "无");
		Riddle riddle174	= new Riddle("	鸟飞鹅跳，月上中梢，目上朱砂，已异非巳，勺旁傍白，万事开头，工戈不全，雨下挚友，称断人和。 (猜一猜)	","	 我用自己的方式爱你	", "爱情"	, "无");
		Riddle riddle175	= new Riddle("	有两只蜜蜂很相爱,后来母蜜蜂却嫁给了蜘蛛为什么 (猜一猜)	","	 因为这只母蜜蜂爱上网	", "爱情"	, "无");
		...
		Riddle riddle179	= new Riddle("	黄昏恋和大龄剩女的恋爱史(打一电视剧) 	","	 《我和老妈一起嫁》	", "爱情"	, "无");
		Riddle riddle180	= new Riddle("	麻辣情感小夫妻，都市宝宝惹争议(打一热门电影) 	","	 《小儿难养》	", "爱情"	, "无");
		...
		Riddle riddle186	= new Riddle("	月露良宵拜魁星，老牛庆生也不迟(打一节日) 	","	 七夕节	", "爱情"	, "无");
		Riddle riddle187	= new Riddle("	大律师与五位妻子间的爱恨情仇(打一热门电视剧) 	","	 《名媛望族》	", "爱情"	, "无");
		Riddle riddle188	= new Riddle("	树儿睁开眼，小子屋下眠，良心缺一点，日落残兔边。 (猜一猜)	","	 相见恨晚	", "爱情"	, "无");
		Riddle riddle189	= new Riddle("	折磨人的东西，男女为之所困(打一名词) 	","	 爱情	", "爱情"	, "无");
		Riddle riddle190	= new Riddle("	一只蚂蚁居然从四川爬到了东京，可能吗？ (猜一猜)	","	 可能从地图上	", "爱情"	, "无");
		Riddle riddle191	= new Riddle("	在绝境中萌生的爱情(打一电影) 	","	 《最爱》	", "爱情"	, "无");
		Riddle riddle192	= new Riddle("	什么东西闭着眼睛可以看到睁着研究却看不到? (猜一猜)	","	 梦	", "爱情"	, "无");
		Riddle riddle193	= new Riddle("	此情可待成追忆，只是当时已惘然(打一歌曲) 	","	 《有多少爱可以重来》	", "爱情"	, "无");
		Riddle riddle194	= new Riddle("	浪漫真情(打一花卉) 	","	 紫玫瑰	", "爱情"	, "无");
		Riddle riddle195	= new Riddle("	天鹅飞去鸟不归，怀念昔日空费心，云开月下双匕影，水流几处又相逢，日落月出人倚月，单身贵族尔相随。 (猜一猜)	","	 我不能没有你	", "爱情"	, "无");
		Riddle riddle196	= new Riddle("	带上真心去相亲，闲人免谈(打一综艺节目) 	","	 非诚勿扰	", "爱情"	, "无");
		Riddle riddle197	= new Riddle("	古树撑天枝难觅，怀抱可怜却无心，赵国有妃不是女，鹅毛轻飘鸟不见，远去不想囊羞涩，受尽苦难又换友，自称有人伴君旁 (猜一猜)	","	 对不起我还爱你	", "爱情"	, "无");
		Riddle riddle198	= new Riddle("	要爱爱我(打一国外节日) 	","	 圣诞节	", "爱情"	, "无");
		Riddle riddle199	= new Riddle("	为什么女人说男人都不是好东西？ (猜一猜)	","	 因为她之前没有遇到过好男人	", "爱情"	, "无");
		Riddle riddle200	= new Riddle("	十八岁的姑娘被锁深宫 (猜一个字)	","	 困 (十八是木，深宫四面围墙所以是口)	", "爱情"	, "无");
		...
		Riddle riddle206	= new Riddle("	小刚能4个小时不眨眼，为什么？ (猜一猜)	","	 因为他睡着了	", "爱情"	, "无");
		Riddle riddle207	= new Riddle("	我想有个家(打四字常用语) 	","	 希望所在	", "爱情"	, "无");
		Riddle riddle208	= new Riddle("	淮海又见水退时，双人换走阻碍石，月顶右手不见口，青年男女树心旁，世上何物最懂爱  (猜一猜)	","	 难得有情人	", "爱情"	, "无");
		...
		Riddle riddle212	= new Riddle("	大明的英语非常好，可是有些老外却听不懂，为什么？ (猜一猜)	","	 日本人听他说英语	", "爱情"	, "无");
		Riddle riddle213	= new Riddle("	窈窕淑女，暗自求爱(打一奥运明星) 	","	 邱波(“暗自求爱”即为“暗送秋波”)	", "爱情"	, "无");
		Riddle riddle214	= new Riddle("	无告白不恋爱(打一电视剧) 	","	 《爱情是从告白开始的》	", "爱情"	, "无");
		...
		Riddle riddle219	= new Riddle("	天鹅飞去鸟不归， 良字无头双人配； 受字中间多两笔(双木非林心相连)， 人尔结合就是自己。 (猜一猜)	","	 我很爱<想>你	", "爱情"	, "无");
		Riddle riddle220	= new Riddle("	半夜有行舟探骊格 (猜一猜)	","	 泊人一·时迁	", "爱情"	, "无");
		Riddle riddle221	= new Riddle("	小小绒球随风飘，深情爱意停不了(打一花卉) 	","	 蒲公英	", "爱情"	, "无");
		Riddle riddle222	= new Riddle("	古树撑天枝难觅，怀抱可怜却无心，赵国有妃不是女，鹅毛轻飘鸟不见，远去不想囊羞涩，受尽苦难又换友，自称有人伴君旁。(猜一猜) 	","	 对不起我还爱你	", "爱情"	, "无");
		Riddle riddle223	= new Riddle("	什么数字最听话呢？ (猜一猜)	","	 100，百依百顺	", "爱情"	, "无");
		Riddle riddle224	= new Riddle("	弑夫女犯与情场骗子的闪恋(打一热门电影) 	","	 《晚秋》	", "爱情"	, "无");
		Riddle riddle225	= new Riddle("	春雨季，梧桐树上结丝绸；夏日凉，两人阵中称英雄；秋风起，鸿雁传音数千里；冬雪飘，美女为何露半腰。 (猜一猜)	","	 绝对重要	", "爱情"	, "无");
		Riddle riddle226	= new Riddle("	帮妻子学文化(打一教育用语) 	","	 教室	", "爱情"	, "无");
		Riddle riddle227	= new Riddle("	30岁女教师和17岁高中生的危险恋情(打一电影) 	","	 《智齿》	", "爱情"	, "无");
		Riddle riddle228	= new Riddle("	小华的男朋友说小华吃的少小华却生气了为什么？(猜一猜)	","	 他说小华肚量小，小华当然生气了	", "爱情"	, "无");
		Riddle riddle229	= new Riddle("	热恋中的情侣(打一诗句) 	","	 相看两不厌	", "爱情"	, "无");
		Riddle riddle230	= new Riddle("	你知道聪明和傻子的区别吗？(猜一猜) 	","	 傻子提问聪明	", "爱情"	, "无");
		Riddle riddle231	= new Riddle("	那种人一年只工作一次？ (猜一猜)	","	 圣诞老人	", "爱情"	, "无");
		Riddle riddle232	= new Riddle("	辰时下雨 地动山摇  (打一个字) 	","	 震	", "爱情"	, "无");
		Riddle riddle233	= new Riddle("	春雨季梧桐树上结丝绸；夏日凉两人阵中称英雄；秋风起鸿雁传音数千里；冬雪飘美女为何露半腰。 (猜一猜) 	","	 绝对重要	", "爱情"	, "无");
		...
		Riddle riddle237	= new Riddle("	纸上写着某个命令，但是，看到此文字的人绝对不能宣读命令。那么，纸上写的是什么呢？ 	","	 不要念出此	", "爱情"	, "无");
		Riddle riddle238	= new Riddle("	我心载着你，不上你的船，已在不言中，双人日下行，燕子离鹅去，马口解猜疑	","	 您还记得我吗	", "爱情"	, "无");
		Riddle riddle239	= new Riddle("	三角恋(打一热门电影) 	","	 2012最新电影：《危险关系》	", "爱情"	, "无");
		Riddle riddle240	= new Riddle("	泰山拉着树腾在丛林间穿梭时，为什么要扯着喉咙大叫？ (猜一猜)	","	 他怕不相似的猴子迎面扑过来	", "爱情"	, "无");

		Riddle riddle241	= new Riddle("	句号(打四字常用语) 	","	 可圈可点	", "搞笑"	, "无");
		Riddle riddle242	= new Riddle("	拉出去的屎(打一成语) 	","	 有去无回	", "搞笑"	, "无");
		Riddle riddle243	= new Riddle("	房屋,宫殿,岩洞,大厦,牛棚,那个词与众不同？ 	","	 岩洞，其它都是人工的	", "搞笑"	, "无");
		Riddle riddle244	= new Riddle("	八戒的屁股(打一明星) 	","	 朱茵	", "搞笑"	, "无");
		Riddle riddle245	= new Riddle("	只哼哼曲调,不唱歌词,为什么？(打一女明星) 	","	 吴佩慈(无配词)	", "搞笑"	, "无");
		...
		Riddle riddle250	= new Riddle("	小刚住一楼为什么还有恐高症？ 	","	 他怕他妈妈，因为他妈妈姓高	", "搞笑"	, "无");
		Riddle riddle251	= new Riddle("	红冠黑嘴白衣裳，双腿细瘦走路晃，漫步水中捕鱼虾，凌空展翅能飞翔。(打一动物)	","	 鹤	", "搞笑"	, "无");
		...
		Riddle riddle257	= new Riddle("	狮子，老虎，骡子，鹿在大漠里面行走谁渴？ (猜一猜)	","	 鹿渴(look)	", "搞笑"	, "无");
		Riddle riddle258	= new Riddle("	怎样才能防止第二次感冒？ (猜一猜)	","	 得第二次感冒后就不会再有第二次感冒了	", "搞笑"	, "无");
		...
		Riddle riddle262	= new Riddle("	白弟弟，黑哥哥，排排坐，爱唱歌，丁冬，丁冬，快乐多 (猜一猜)	","	 钢琴	", "搞笑"	, "无");
		Riddle riddle263	= new Riddle("	一个风箱真奇怪，一拉它就唱起来。 (打一乐器) 	","	 手风琴	", "搞笑"	, "无");
		Riddle riddle264	= new Riddle("	别抖，稳住了再开枪。(八字口语) 	","	 不要动不动就发火	", "搞笑"	, "无");
		...
		Riddle riddle270	= new Riddle("	三个金鑫，三个水叫淼，三个人叫众，那么三个鬼应该叫什么? (猜一猜)	","	 叫救命	", "搞笑"	, "无");
		...
		Riddle riddle275	= new Riddle("	小飞贼，水里生，干坏事，狠又凶，偷偷摸摸吸人血，还要嗡嗡叫几声。(打一动物)	","	 蚊子	", "搞笑"	, "无");
		Riddle riddle276	= new Riddle("	火辣辣的手(打一花卉) 	","	 红掌(别称“火鹤花、安祖花”)	", "搞笑"	, "无");
		Riddle riddle277	= new Riddle("	号称山大王，树干冲天长，叶儿尖似针，造屋好做梁。(打一植物) 	","	 杉树	", "搞笑"	, "无");
		Riddle riddle278	= new Riddle("	天南地北都能住，春风给我把辫梳，溪畔湖旁搭凉棚，能撒雪花当空舞。(打一植物)	","	 柳树	", "搞笑"	, "无");
		...
		Riddle riddle286	= new Riddle("	一只手能干的事情(打一热门小说) 	","	 《遮天》(因为“只手遮天”)	", "搞笑"	, "无");
		...
		Riddle riddle293	= new Riddle("	兜售小三(打一美国城市) 	","	 迈阿密(卖，阿密：小三(小秘))	", "搞笑"	, "无");
		Riddle riddle294	= new Riddle("	你知道最有价值的布是什么吗？(猜一猜) 	","	 瀑布	", "搞笑"	, "无");
		Riddle riddle295	= new Riddle("	用被子盖住屁股(打一个城市名字) 	","	 保定(抱定 ，定徐州话屁股)	", "搞笑"	, "无");
		Riddle riddle296	= new Riddle("	手捧一把棍(打一复姓) 	","	 端木	", "搞笑"	, "无");
		Riddle riddle297	= new Riddle("	把尿喝光不撑肚，妈妈有它少烦恼(打一生活用品) 	","	 尿不湿	", "搞笑"	, "无");
		Riddle riddle298	= new Riddle("	什么时候，时代广场的大钟会响13下？ (猜一猜)	","	 该修理的时候	", "搞笑"	, "无");
		...
		Riddle riddle302	= new Riddle("	百货公司里，有个秃头的推销员，正在促销生发水，你知道他为什么自己不用生发水呢？(猜一猜)	","	 他想让大家知道秃头有多难看	", "搞笑"	, "无");
		...
		Riddle riddle313	= new Riddle("	一架坐满人的飞机坠落，却没有人受伤。为什么？(猜一猜) 	","	 因为都死了	", "搞笑"	, "无");
		Riddle riddle314	= new Riddle("	海南宝岛是我家，不怕风吹和雨打，四季棉衣不离身，肚里有肉又有茶。(打一植物)	","	 椰子	", "搞笑"	, "无");
		Riddle riddle315	= new Riddle("	男女关系不清不白(打一歌曲) 	","	 《暧昧》——杨丞琳	", "搞笑"	, "无");
		Riddle riddle316	= new Riddle("	曲从其命(打一曲艺用语) 	","	 绕口令	", "搞笑"	, "无");
		Riddle riddle317	= new Riddle("	你在什么时候喜欢喝汽水？ (猜一猜)	","	 在孤单的时候(当你孤单你会想汽水)	", "搞笑"	, "无");
		...
		Riddle riddle322	= new Riddle("	外披麻衣裟，内穿红大褂。胖子里面藏，地下自安家(打一农作物) 	","	 花生	", "儿童"	, "无");
		Riddle riddle323	= new Riddle("	被马来西亚视为不吉祥的花(打一花卉) 	","	 蝙蝠花(因为不讨喜的外型)	", "儿童"	, "无");
		...
		Riddle riddle328	= new Riddle("	八十万禁军教头，人称豹子头(打一水浒传人物名) 	","	 林冲	", "儿童"	, "无");
		Riddle riddle329	= new Riddle("	我有一个好帮手，书本文具帮我拿，每天跟我上学校(打一物) 	","	 书包	", "儿童"	, "无");
		Riddle riddle330	= new Riddle("	长生果儿穿麻衣，植物肉儿白身体(打一食物) 	","	 花生	", "儿童"	, "无");
		Riddle riddle331	= new Riddle("	样子像小船，角儿两头翘，骨头在外面，肉儿里头包。(打一植物) 	","	 菱角	", "儿童"	, "无");
		Riddle riddle332	= new Riddle("	一根根，两成双，三个指头夹住它(打一生活用品) 	","	 筷子	", "儿童"	, "无");
		Riddle riddle333	= new Riddle("	头上毛发像大便，好吃懒做大肥羊。(打一动画角色) 	","	 懒羊羊	", "儿童"	, "无");
		Riddle riddle334	= new Riddle("	调皮小萝莉(打一网站名) 	","	 淘宝网(淘气的宝宝)	", "儿童"	, "无");
		Riddle riddle335	= new Riddle("	八仙过海到此地，伏羲女娲居其中(打一地名) 	","	 蓬莱(烟台县级市)	", "儿童"	, "无");
		Riddle riddle336	= new Riddle("	一堆黄豆豆,磨碎熬白汤,凝成大块块,吃来嫩又香(打一食品) 	","	 豆腐	", "儿童"	, "无");
		Riddle riddle337	= new Riddle("	两只小小船，陪你在身边，白天到处走，晚上停床边(打一日用品) 	","	 鞋	", "儿童"	, "无");
		Riddle riddle338	= new Riddle("	多出一半(打一个字) 	","	 岁	", "儿童"	, "无");
		Riddle riddle339	= new Riddle("	有个大肚皮,真是怪脾气,张着大嘴街上站,专吃各种脏东西(打一日用品) 	","	 垃圾桶	", "儿童"	, "无");
		Riddle riddle340	= new Riddle("	鱼为什么生活在水里？ (猜一猜)	","	 因为猫在岸上	", "儿童"	, "无");
		Riddle riddle341	= new Riddle("	方方一块布,布上长疙瘩，天天去洗脸，说我好娃娃(打一日用品) 	","	 毛巾	", "儿童"	, "无");
		Riddle riddle342	= new Riddle("	鹿儿雪橇响叮当，小小礼物娃娃抢(打一国外节日) 	","	 圣诞节	", "儿童"	, "无");
		Riddle riddle343	= new Riddle("	灯暗秋寒明月隐(打一花名) 	","	 丁香	", "儿童"	, "无");
		Riddle riddle344	= new Riddle("	湿、绿、岸、春、透组成一句话，哈哈 (猜一猜)	","	 岸湿透春绿，俺是头蠢驴！	", "儿童"	, "无");
		Riddle riddle345	= new Riddle("	小明考了96分小华比小明多一点小华考了多少分 (猜一猜)	","	 9.6分	", "儿童"	, "无");
		Riddle riddle346	= new Riddle("	比牛大，吃嫩草，头上长只弯弯角。老虎见它让三分，力大无穷脾气暴。( 打一动物)	","	 犀牛	", "儿童"	, "无");
		Riddle riddle347	= new Riddle("	身细头尖鼻子大，一根线儿拴住它， 帮助妈妈缝衣裳，帮助姐姐来绣花。 (猜一猜)	","	 针	", "儿童"	, "无");
		Riddle riddle348	= new Riddle("	远看像雪花，海水中有它。用途非常广，做菜顶呱呱(打一调味品) 	","	 盐	", "儿童"	, "无");
		Riddle riddle349	= new Riddle("	头裹布巾的小女孩(打一儿歌) 	","	 《小红帽》	", "儿童"	, "无");
		Riddle riddle350	= new Riddle("	红皮红瓤瓤,酸甜有营养,生吃赛水果,蛋炒味道香(打一蔬菜) 	","	 西红柿	", "儿童"	, "无");
		Riddle riddle351	= new Riddle("	半推半就 (猜一字) 	","	 掠	", "儿童"	, "无");
		Riddle riddle352	= new Riddle("	七个男孩智斗美人儿(打一动画片) 	","	 《葫芦娃》	", "儿童"	, "无");
		Riddle riddle353	= new Riddle("	一点一横长，方砖顶房梁。大口张着嘴，小口里面藏 	(猜一猜)","	 高	", "儿童"	, "无");
		Riddle riddle354	= new Riddle("	死去何所知打酒名一 (猜一猜)	","	 百年糊涂	", "儿童"	, "无");
		Riddle riddle355	= new Riddle("	远看像张弓，立在河当中。上面车马过，底下轮船游。(打一交通设施) 	","	 桥	", "儿童"	, "无");
		Riddle riddle356	= new Riddle("	戴绿帽披绿衫,白天黑夜邮局站,书信往来它传递，准确及时又安全(打一物品)	","	 邮筒	", "儿童"	, "无");
		Riddle riddle357	= new Riddle("	默默站在马路边,没到夜晚亮闪闪,汽车行人从旁过，尽职尽责保安全(打一交通设施)	","	 路灯	", "儿童"	, "无");
		Riddle riddle358	= new Riddle("	轻轻跑过水面,水面浪花飞溅,树叶哗哗鼓掌,响声连成一片(打一自然现象) 	","	 风	", "儿童"	, "无");
		Riddle riddle359	= new Riddle("	身披黄袍营养高，热带果王味道好(打一水果) 	","	 芒果	", "儿童"	, "无");
		Riddle riddle360	= new Riddle("	小时开白花,大时结黄果,皮粗果肉细,吃了能败火(打一水果) 	","	 梨	", "儿童"	, "无");
		Riddle riddle361	= new Riddle("	一只像耳插在后，一条象鼻长在前，肚子像孕妇，有水往里灌 	","	 水壶	", "儿童"	, "无");
		Riddle riddle362	= new Riddle("	木头上面来回走,光有牙,没有口(打一物) 	","	 锯子	", "儿童"	, "无");
		Riddle riddle363	= new Riddle("	冬天蟠龙卧，夏天枝叶开，龙须往上长，珍珠往下排。(打一植物) 	","	 葡萄	", "儿童"	, "无");
		Riddle riddle364	= new Riddle("	一个老爷爷，推他他不倒，总爱把头摇(打一物) 	","	 不倒翁	", "儿童"	, "无");
		Riddle riddle365	= new Riddle("	壳儿硬，门板隔，里面藏个皱脸老婆婆(打一坚果) 	","	 核桃	", "儿童"	, "无");
		Riddle riddle366	= new Riddle("	平安的果子 (打一水果) 	","	 苹果	", "儿童"	, "无");
		Riddle riddle367	= new Riddle("	小小银针本领高，扎了脑袋扎双脚。外国朋友也欢迎，针到病除乐陶陶。(打一治病方法) 	","	 针灸	", "儿童"	, "无");
		Riddle riddle368	= new Riddle("	四四方方像块糖，写错字儿用它擦(打一学习用品) 	","	 橡皮擦	", "儿童"	, "无");
		Riddle riddle369	= new Riddle("	身材细又长，头上长着毛，每天把它用，做个好宝宝(打一日用品) 	","	 牙刷	", "儿童"	, "无");
		...
		Riddle riddle374	= new Riddle("	吃进青青草,挤出甜甜水,谢谢牛妈妈,让我快长大(打一食品) 	","	 牛奶	", "儿童"	, "无");
		Riddle riddle375	= new Riddle("	身材纤细披绿袍，切碎包饺味儿好(打一蔬菜) 	","	 芹菜	", "儿童"	, "无");
		Riddle riddle376	= new Riddle("	圆圆浆果色泽艳，草龙珠儿味道甜(打一水果) 	","	 葡萄	", "儿童"	, "无");
		Riddle riddle377	= new Riddle("	小花儿，像喇叭，公鸡打鸣就开放(打一花类) 	","	 牵牛花	", "儿童"	, "无");
		Riddle riddle378	= new Riddle("	一座小楼房,有门没有窗。打开看一看,全是花衣裳(打一家具) 	","	 衣柜	", "儿童"	, "无");
		Riddle riddle379	= new Riddle("	一个绿娃娃，肚里水汪汪，若是剖开看，红汁往外淌(打一水果) 	","	 西瓜	", "儿童"	, "无");
		Riddle riddle380	= new Riddle("	没有孩子却当娘，欢欢喜喜红线牵。 (打一角色) 	","	 红娘	", "儿童"	, "无");
		Riddle riddle381	= new Riddle("	小小哥儿鼻子长，肚子还能把水装。它见花儿流眼泪，花儿见它笑哈哈。(打一物)	","	 洒水壶	", "儿童"	, "无");
		Riddle riddle382	= new Riddle("	一头青来一头白，胡子还在地里埋。头上顶朵小白花，烹饪调味品质佳。(打一蔬菜)	","	 葱	", "儿童"	, "无");
		Riddle riddle383	= new Riddle("	毛茸茸像羽毛，大风一吹到处飞(打一植物) 	","	 蒲公英	", "儿童"	, "无");
		Riddle riddle384	= new Riddle("	别看不会说话,无脚能行千里,先报一路平安,话都装在肚里(打一日用品) 	","	 信	", "儿童"	, "无");
		...
		Riddle riddle391	= new Riddle("	胖娃娃，嘴真大，不管吃啥都要它(打一生活用品) 	","	 碗	", "儿童"	, "无");
		Riddle riddle392	= new Riddle("	就怕热不怕冷,像玻璃亮晶晶,数九寒天河里有,春暖花开难找寻(打一自然物) 	","	 冰	", "儿童"	, "无");
		Riddle riddle393	= new Riddle("	热带果王(打一水果) 	","	 芒果	", "儿童"	, "无");
		Riddle riddle394	= new Riddle("	丘比特之剑 -的一中药 	","	 穿心莲。了(箭把两颗心穿透连在一起)	", "儿童"	, "无");
		Riddle riddle395	= new Riddle("	嘴巴大又大,从来不讲话。盛汤又装饭,落地会摔烂(打一物) 	","	 碗	", "儿童"	, "无");
		Riddle riddle396	= new Riddle("	人脱衣服，它穿衣服，人脱帽子，它戴帽子(打一物品) 	","	 衣帽架	", "儿童"	, "无");
		Riddle riddle397	= new Riddle("	洁白如玉有大口，装菜盛饭好帮手(打一生活用品) 	","	 碗	", "儿童"	, "无");
		Riddle riddle398	= new Riddle("	一匹马儿两人骑，这边高来那边低， 虽然马儿不会跑，两人骑着笑嘻嘻。 (打一玩具)	","	 跷跷板	", "儿童"	, "无");
		Riddle riddle399	= new Riddle("	IQ博士智商高，机器娃娃也来造；近视娃娃个头小，最爱说着哦呦呦(打一动漫人物)	","	 阿拉蕾	", "儿童"	, "无");
		Riddle riddle400	= new Riddle("	你有两只眼,它有两只眼,剧场来看戏,它能看得远(打一科技产品) 	","	 望远镜	", "儿童"	, "无");

		Riddle riddle401	= new Riddle("	卡罗拉(打一英文单词) 	","	 corolla花冠	", "英语"	, "无");
		Riddle riddle402	= new Riddle("	怕失去(打一英文单词) 	","	 parsimonious	", "英语"	, "无");
		Riddle riddle403	= new Riddle("	What has hands but no feet, a face but no eyes, tells but not talk? (猜一猜)","	 alarm clock 闹钟	", "英语"	, "无");
		Riddle riddle404	= new Riddle("	台湾姐妹明星(打一英文字) 	","	 s	", "英语"	, "无");
		Riddle riddle405	= new Riddle("	Why don't you advertise for your lost dog? (猜一猜)	","	 He can't read.	", "英语"	, "无");
		Riddle riddle406	= new Riddle("	Why is the library the highest building? (猜一猜)	","	 It has the most stories.	", "英语"	, "无");
		Riddle riddle407	= new Riddle("	When the boy fell into the water, what's the first thing he did? (猜一猜)	","	 He got wet first of all.	", "英语"	, "无");
		Riddle riddle408	= new Riddle("	什么英文字母让人们喜欢听而且听的人最多？ (猜一猜)	","	 CD	", "英语"	, "无");
		Riddle riddle409	= new Riddle("	话说26个字母在外太空，ABC跑地球来了，外太空还有多少个字母	 (猜一猜)","	 20个，他们坐UFO下来的！	", "英语"	, "无");
		Riddle riddle410	= new Riddle("	What animal wears big black glasses on its face? (猜一猜)	","	 Panda熊猫	", "英语"	, "无");
		Riddle riddle411	= new Riddle("	阴塞(打一英语单词) 	","	 inside	", "英语"	, "无");
		Riddle riddle412	= new Riddle("	What always goes up and never goes down?(什么东西只升不降？)	","	 Your age. (你的年龄)	", "英语"	, "无");
		Riddle riddle413	= new Riddle("	摸(打一英文单词) 	","	 more(多，更多)	", "英语"	, "无");
		Riddle riddle414	= new Riddle("	C型的锁 (打一英文) 	","	 clock.	", "英语"	, "无");
		Riddle riddle415	= new Riddle("	How long can a goose stand on one leg？(多久能鹅单腿站立？) 	","	 try it and see	", "英语"	, "无");
		Riddle riddle416	= new Riddle("	what month do soldiers hate (猜一猜)	","	 March 3月	", "英语"	, "无");
		Riddle riddle417	= new Riddle("	俺靠(打一英文单词) 	","	 uncle叔叔；伯父；舅父；姑父，姨父。	", "英语"	, "无");
		Riddle riddle418	= new Riddle("	What kind of water should people drink in order to be healthy? (猜一猜)","	 Drink well water.	", "英语"	, "无");
		Riddle riddle419	= new Riddle("	狗打毛宁(打一英文短语) 	","	 Good morning!早上好！	", "英语"	, "无");
		Riddle riddle420	= new Riddle("	Why did the farmer take his chicken to task?(农夫为什么训斥小鸡？)	","	 Because they use foul language. 因为它们说脏话。	", "英语"	, "无");
		Riddle riddle421	= new Riddle("	一窝蚊子(打一英语单词) 	","	 involving	", "英语"	, "无");
		Riddle riddle422	= new Riddle("	What has teeth but cannot eat? (猜一猜)","	 A comb	", "英语"	, "无");
		Riddle riddle423	= new Riddle("	Why do some old people never use glasses? (猜一猜)	","	 They must prefer bottles to glasses.	", "英语"	, "无");
		Riddle riddle424	= new Riddle("	What has four eyes but cannot see? (猜一猜)	","	 密西西比州	", "英语"	, "无");
		Riddle riddle425	= new Riddle("	海味(打一英文单词) 	","	 heavy	", "英语"	, "无");
		Riddle riddle426	= new Riddle("	皮蛋(打一英文) 	","	 Q	", "英语"	, "无");
		Riddle riddle427	= new Riddle("	Why is the inside of everything so mysterious?(为什么说凡事内部都神秘莫测？)	","	 ecause you can never make them out. 因为你永远也不能弄懂它们。	", "英语"	, "无");
		Riddle riddle428	= new Riddle("	迪斯科(打一英文单词) 	","	 disco	", "英语"	, "无");
		Riddle riddle429	= new Riddle("	What comes after the letter 'A'? (猜一猜)	","	 All the other letters.	", "英语"	, "无");
		Riddle riddle430	= new Riddle("	216个小时打一个字 	","	 旭(因为216小时是九日)	", "英语"	, "无");
		Riddle riddle431	= new Riddle("	堤坝(打一英文单词) 	","	 debar	", "英语"	, "无");
		Riddle riddle432	= new Riddle("	What part of London is in Brazil? (猜一猜)	","	 The letter 'L'.	", "英语"	, "无");
		Riddle riddle433	= new Riddle("	为立志(打一英文单词) 	","	 village村民；乡村，村庄；群落。	", "英语"	, "无");
		Riddle riddle434	= new Riddle("	卖几颗(打一英文单词) 	","	 magic(魔法，魔术)	", "英语"	, "无");
		Riddle riddle435	= new Riddle("	赖(打一英文单词) 	","	 lie	", "英语"	, "无");
		Riddle riddle436	= new Riddle("	What question can you never answer 'Yes' to? (猜一猜)	","	 Are you dead?	", "英语"	, "无");
		Riddle riddle437	= new Riddle("	我的吻车(打一英文单词) 	","	 adventure冒险活动；冒险经历；奇遇。	", "英语"	, "无");
		Riddle riddle438	= new Riddle("	二奶(打一英文单词) 	","	 annoy使烦恼；令人讨厌；烦恼	", "英语"	, "无");
		Riddle riddle439	= new Riddle("	Why do people go to bed?(人们为什么睡觉？)	","	 Because the bed won’t come to us．因为床不会走向我们。	", "英语"	, "无");
		Riddle riddle440	= new Riddle("	逮狸射死(打一英文单词) 	","	 delicious	", "英语"	, "无");
		Riddle riddle441	= new Riddle("	摸钱袋子(打一英文单词) 	","	 merchandise	", "英语"	, "无");
		Riddle riddle442	= new Riddle("	What's the difference between a hill and a pill? (猜一猜)	","	 A hill is hard to get up and a pill is hard to get down	", "英语"	, "无");
		Riddle riddle443	= new Riddle("	What is deaf and dumb but always tells the truth? (打一物) 	","	 mirror	", "英语"	, "无");
		Riddle riddle444	= new Riddle("	What word can you make shorter by adding to it? (猜一猜)	","	 Short.	", "英语"	, "无");
		Riddle riddle445	= new Riddle("	阿匹婆(打一英文名词) 	","	 a people	", "英语"	, "无");
		Riddle riddle446	= new Riddle("	死壮(打一英文单词) 	","	 strong强壮	", "英语"	, "无");
		Riddle riddle447	= new Riddle("	Ten plus ten is ten.Ten minus ten is ten(打一物) 	","	 手套(glove)	", "英语"	, "无");
		Riddle riddle448	= new Riddle("	Where did Columbus stand when he discovered America? (猜一猜)	","	 On his feet.	", "英语"	, "无");
		...
		Riddle riddle457	= new Riddle("	故障女士 (打一动物) 	","	 lady bug(瓢虫)。	", "英语"	, "无");
		Riddle riddle458	= new Riddle("	有没有你，颜色都不变 (打一英文) 	","	 colour/color	", "英语"	, "无");
		Riddle riddle459	= new Riddle("	What never asks questions but gets a lot of answers? (猜一猜)	","	 dictionary	", "英语"	, "无");
		Riddle riddle460	= new Riddle("	俺必胜(打一英文单词) 	","	 ambition雄心	", "英语"	, "无");
		Riddle riddle461	= new Riddle("	蔻驰(打一英文单词) 	","	 教练；指导；受训练。	", "英语"	, "无");
		Riddle riddle462	= new Riddle("	What is that which has a mouth,but never speaks, and a bed, but never sleeps in it?	(猜一猜)","	 A river.	", "英语"	, "无");
		Riddle riddle463	= new Riddle("	额耐克(打一英语单词) 	","	 alike(相同的，相像的 )	", "英语"	, "无");
		Riddle riddle464	= new Riddle("	我跑(打一英文单词) 	","	 appall惊骇	", "英语"	, "无");
		Riddle riddle465	= new Riddle("	What is never used until it's broken? (猜一猜)	","	 An egg	", "英语"	, "无");
		Riddle riddle466	= new Riddle("	What can you break with only one word? (猜一猜)	","	 Silence.	", "英语"	, "无");
		Riddle riddle467	= new Riddle("	How do we know the ocean is friendly? (猜一猜)	","	 It waves.	", "英语"	, "无");
		Riddle riddle468	= new Riddle("	What stays indoors no matter how many times you put it out? (猜一猜)	","	 The light.	", "英语"	, "无");
		Riddle riddle469	= new Riddle("	Which horses have six legs? (猜一猜)	","	 All horses have forelegs	", "英语"	, "无");
		...
		Riddle riddle473	= new Riddle("	what letter is an animal? (打一英文字母)	","	 B	", "英语"	, "无");
		Riddle riddle474	= new Riddle("	潲哇(打一英文单词)	","	 shower阵雨；淋浴；淋浴器；一大批；下阵雨；似阵雨般降落；洒落；纷纷降落。	", "英语"	, "无");
		Riddle riddle475	= new Riddle("	死洞(打一英文单词) 	","	 stone(石头、宝石)	", "英语"	, "无");
		Riddle riddle476	= new Riddle("	How does the sun affect weight？(太阳如何影响重量？) 	","	 It makes the daylight.	", "英语"	, "无");
		Riddle riddle477	= new Riddle("	爱过你(打一英文单词) 	","	 agony痛苦	", "英语"	, "无");
		Riddle riddle478	= new Riddle("	Why can a bride hide nothing?(为什么新娘子什么也藏不住？)	","	 Because someone will give her away.	", "英语"	, "无");
		...
		Riddle riddle498	= new Riddle("	我困在一个密室里(打一字) 	","	 圄(“吾”寓意“我”)	", "字谜"	, "无");
		...
		Riddle riddle502	= new Riddle("	一个人过七夕(打一字) 	","	 死(“一”+“七”+“夕”=“死’)	", "字谜"	, "无");
		...
		Riddle riddle510	= new Riddle("	一笔不直,二笔不曲,三笔有直有曲,数量单位却很大.(打一字) 	","	 亿	", "字谜"	, "无");
	...
	private void next() {
		this.startActivity(new Intent(this, MainFragmentActivity.class));
		this.finish();
	}
